...
SECRET_KEY = 'django-insecure-&uqexkl(a4&h4n6o&_m9ia9*n8kni0$4*$@hkv7mzjl^%^#ace'
...
CORS_ALLOWED_ORIGINS =[
    'http://localhost:5173',
    'https://phimart-client-sigma.vercel.app'
]
...
SWAGGER_SETTINGS = {
   'SECURITY_DEFINITIONS': {
      'Bearer': {
            ...
            'name': 'Authorization',
            'in': 'header',
            'description' : 'Enter your JWT token in the following format `JWT <your_token>`'
      }
   }
}
